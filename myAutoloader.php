...
/*
[TO DO] Идея. Добавить в функцию myAutoloader проверку на существование файла file_exists().
 ...
 * Во вложенных папках в namespase нужно указывать имя папки, т.е. namespace должны совпадать с названиями папок
 * например для папки classes с файлом Foo.php namespace должен быть таким namespace classess;
